...
namespace Turorials_FUDGEPhysics_Lesson1 {
    ...
    function init(_event: Event): void {
        ...
        ball = createNodeWithComponents("Ball", materialBall, new f.MeshSphere(),1,f.PHYSICS_TYPE.DYNAMIC,f.PHYSICS_GROUP.GROUP_1, f.COLLIDER_TYPE.SPHERE,null);
 ...
 f.Physics.world.simulate(f.Loop.timeFrameReal / 1000)
    ...
    function createNodeWithComponents(_name: string, _material: f.Material, _mesh: f.Mesh,_masse:number, _physicsType: f.PHYSICS_TYPE, _group: f.PHYSICS_GROUP, _colType: f.COLLIDER_TYPE, _convexMesh: Float32Array): f.Node {
        ...
        let cmgRigisbody: f.ComponentRigidbody = new f.ComponentRigidbody(_masse, _physicsType, _colType, _group, null, _convexMesh);
        ...
        node.addComponent(cmgRigisbody);
    ...
    function settingUpAPlayer(): void {
        player = createNodeWithComponents("Player", materialPlayer, new f.MeshCube(), playerWeight,f.PHYSICS_TYPE.DYNAMIC,f.PHYSICS_GROUP.DEFAULT,f.COLLIDER_TYPE.CAPSULE,null);
        ...
        let playerNose: f.Node = createNodeWithComponents("PlayerNose", materialPlayer, new f.MeshCube(), playerWeight,f.PHYSICS_TYPE.DYNAMIC,f.PHYSICS_GROUP.DEFAULT,f.COLLIDER_TYPE.CAPSULE,null);
    ...
    function settingUpEnvironment() {
        environment[0] = createNodeWithComponents("Ground", materialEnvironment, new f.MeshCube(),0,);
