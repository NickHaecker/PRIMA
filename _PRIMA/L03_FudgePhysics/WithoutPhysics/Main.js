...
(function (Turorials_FUDGEPhysics_Lesson1) {
    ...
    function createNodeWithComponents(_name, _material, _mesh, _masse, _physicsType, _group, _colType, _convexMesh) {
        let node = new f.Node(_name);
        let cmpMesh = new f.ComponentMesh(_mesh);
        let cmpMaterial = new f.ComponentMaterial(_material);
        let cmpTransform = new f.ComponentTransform();
        let cmgRigisbody = new f.ComponentRigidbody(_masse, _physicsType, _colType, _group, null, _convexMesh);
    ...
    function settingUpAPlayer() {
        ...
        let playerNose = createNodeWithComponents("PlayerNose", materialPlayer, new f.MeshCube(), playerWeight, f.PHYSICS_TYPE.DYNAMIC, f.PHYSICS_GROUP.DEFAULT, f.COLLIDER_TYPE.CAPSULE, null);
